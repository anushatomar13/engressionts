"""
EnBEATS (Engression-enhanced N-BEATS)
-------
"""
...
class _Block(nn.Module):
    def __init__(
        ...
        """PyTorch module implementing the basic building block of the EnBEATS (Engression-enhanced N-BEATS) architecture.
...
class _Stack(nn.Module):
    def __init__(
        ...
        """PyTorch module implementing one stack of the EnBEATS (Engression-enhanced N-BEATS) architecture that comprises multiple basic blocks.
...
class _EnBEATSModule(EngressionPLModule):
    def __init__(
        ...
        **kwargs,
        ...
        """PyTorch module implementing the EnBEATS (Engression-enhanced N-BEATS) architecture.
        ...
        generic_architecture
            Boolean value indicating whether the generic architecture of EnBEATS (Engression-enhanced N-BEATS) is used.
